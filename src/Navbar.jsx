        ...
        <Navbar.Collapse id="navbarScroll">
          ...
          >
            ...
            <NavDropdown title="Linear Algebraic Equations" id="navbarScrollingDropdown">
              ...
              <NavDropdown.Item href="./Gaussian">Gaussian</NavDropdown.Item>
            ...
            <NavDropdown title="Interpolation" id="navbarScrollingDropdown">
              ...
              <NavDropdown.Item href="./Lagrange">Lagange Interpolation</NavDropdown.Item>
            ...
            <NavDropdown title="Regression" id="navbarScrollingDropdown">
              <NavDropdown.Item href="./LinearLeastSquares">Least-Squares Regression : Linear</NavDropdown.Item>
              <NavDropdown.Item href="./PolynomialLeastSquares">Least-Squares Regression : Polynomial</NavDropdown.Item>

            </NavDropdown>

            <NavDropdown title="Integration and Differentiation" id="navbarScrollingDropdown">
              <NavDropdown.Item href="./TrapezoidalRule">Trapezoidal Rule</NavDropdown.Item>
              <NavDropdown.Item href="./CompositeTrapezoidalRule">Composite Trapezoidal Rule</NavDropdown.Item>
              <NavDropdown.Item href="./SimpsonsRule">Simpson's Rule</NavDropdown.Item>
              <NavDropdown.Item href="./CompositeSimpsonsRule">Composite Simpson's Rule</NavDropdown.Item>
            </NavDropdown>
          </Nav>
        </Navbar.Collapse>
      </Container>
