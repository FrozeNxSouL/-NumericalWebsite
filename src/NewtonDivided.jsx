...
//     const [dataX, setDataX] = useState([0,20000,40000,60000,80000]);
//     const [dataY, setDataY] = useState([9.81,9.7487,9.6879,9.6879,9.5682]);
//     const [selectedIndex, setSelectedIndex] = useState([0,4]);
...
//     const inputSelectedIndex = (event, index)=> {
...
//     const insideCal=( xnew, x, round)=>{
//         if (round-1 < 0){
//             return 1;
//         }
//         else {
//             return (xnew-x[round-1]) * insideCal(xnew,x,round-1);
//         }
//     }
    
//     const calNewY=( C, xnew, x, round)=>{
//         if (round == 0){
//             return C[0];
//         }
//         else {
//             return (C[round]*insideCal(xnew,x,round)) + calNewY(C,xnew,x,round-1);
//         }
//     }
//     const recurr=( round, idx0, idx1, y, x)=>{
//         if (round==0) {return y[idx0];}
//         else if (round == 1){return (y[idx1]-y[idx0]) / (x[idx1] - x[idx0]);}
//         else {return  (recurr(round-1,idx0+1,idx1,y,x)- recurr(round-1,idx0,idx1-1,y,x)) / (x[idx1] - x[idx0]);}
//     }
...
//         let Y = [];
//         let C = [];
//         let index = [...(selectedIndex.sort((a, b) => a - b))];
//         index.forEach((item)=>{
//             X.push(dataX[item]);
//             Y.push(dataY[item]);
//         });
...
//             C[i] = parseFloat(recurr(i, 0, i, Y, X));
//         }

//         output = calNewY(C,input,X,iter);
//         setResult(output);
//     }
...
//                         </Col>
//                         <Row>
//                         <Form.Control type="number" value={level} onChange={(e)=> {inputLevel(e)}}></Form.Control>
//                         </Row>
//                         <Row>
//                         <Button variant="dark" onClick={inputIndex}>set</Button>
//                         </Row>
//                     </InputGroup>
...
//                                 <td key={index}>
//                                     <Form.Control value={selectedIndex[index]} onChange={(e)=> inputSelectedIndex(e, index)}></Form.Control>
//                                 </td>
//                             ))}
//                         </tr>
//                         </tbody>
